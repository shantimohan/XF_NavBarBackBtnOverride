...
using XF_NavBarBackBtnOverride;
using XF_NavBarBackBtnOverride.iOS;

[assembly: ExportRenderer(typeof(BackButtonCustomActionPage), typeof(BackButtonCustomActionPageRenderer))]
namespace XF_NavBarBackBtnOverride.iOS
{
    public class BackButtonCustomActionPageRenderer : PageRenderer
    {
        public override void ViewWillAppear(bool animated)
        {
            base.ViewWillAppear(animated);

            if (((BackButtonCustomActionPage)Element).EnableBackButtonOverride)
            {
                SetCustomBackButton();
            }
        }
        ...
        private void SetCustomBackButton()
        {
            ...
            backBtn.TouchDown += (sender, e) =>
            {
                ...
                if (((BackButtonCustomActionPage)Element)?.CustomBackButtonAction != null)
                {
                    ((BackButtonCustomActionPage)Element)?.CustomBackButtonAction.Invoke();
                }
            };
